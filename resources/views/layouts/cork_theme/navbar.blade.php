<div class="header-container mb-3">
    <header class="header navbar navbar-expand-sm">
        ...
        <a href="javascript:void(0);" class="sidebarCollapse" data-placement="bottom"><i class="far fa-bars"></i></a>

        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href=""> <i class="fas fa-bars"></i><span
                    class="navbar-brand-name">SISVENTAS</span></a>
        </div>
                ...
                <div class="dropdown custom-dropdown-icon">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                        <a class="dropdown-item" data-img-value="flag-de" data-value="German"
                            href="javascript:void(0);"><img src="assets/img/flag-de.svg" class="flag-width" alt="flag">
                            German</a>
                        ...
                        <a class="dropdown-item" data-img-value="flag-fr" data-value="French"
                            href="javascript:void(0);"><img src="assets/img/flag-fr.svg" class="flag-width" alt="flag">
                            French</a>
